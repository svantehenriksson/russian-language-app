              ...
              <>
                ...
                <div className="story-chapter-switch">
                  <ChapterPicker
                    ...
                    triggerClassName="ghost-btn story-action-btn"
                    menuClassName="chapter-picker-menu chapter-picker-menu-floating chapter-picker-menu-up chapter-picker-menu-right"
                    optionClassName="chapter-picker-option"
                    activeOptionClassName="chapter-picker-option-active"
                    menuAriaLabel="Change chapter"
                  />
                </div>
              </>
            ) : (
