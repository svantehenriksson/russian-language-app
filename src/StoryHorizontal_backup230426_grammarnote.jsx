                  ...
                  <div key={`sentence-${sentenceIndex}`} className="story-sentence-block">
                    ...
                    <div className="story-sentence-row story-sentence-row-secondary story-sentence-row-grammar">
                      {(() => {
                        ...
                        return (
                          <span
                            className={`story-grammar-toggle${isPlaceholderNote ? " story-grammar-toggle-disabled" : ""}`}
                            role={isPlaceholderNote ? undefined : "button"}
                            tabIndex={isPlaceholderNote ? -1 : 0}
                            aria-label={note}
                            onClick={
                              isPlaceholderNote ? undefined : () => setOpenGrammarIndex(isOpen ? null : sentenceIndex)
                            }
                            onKeyDown={
                              isPlaceholderNote
                                ? undefined
